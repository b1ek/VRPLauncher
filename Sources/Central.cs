...
namespace VRPLancher
{
    static class Central
    {
        ...
        public const string README_minecraft =
            ...
            "Если вы все же это делаете, понимайте что вы действуете на свой личный риск\n" +
            "и администрация сервера не несет ответственности за ваши действия или любые\n" +
            "ихние последстствия.\n" +
            "\n" +
            "Чтобы вернуть все как было, просто удалите и скачайте снова лаунчер.\n" +
            "\n" +
            "\n" +
            "=======================\n" +
